                ...
                <div className="w-[247px] h-[236px] flex flex-col gap-[15px]">
                  <div className="w-[247px] h-[32px] flex gap-[10px]">
                    <Image
                      ...
                      alt="circle"
                      width={32} // Replace 32 with the actual width of the image
                      height={32} // Replace 32 with the actual height of the image
                    />
                  ...
                  <div className="w-[247px] h-[32px] flex gap-[10px]">
                    <Image
                      src="/images/icn-circle circle-xs mute.png"
                      alt="circle"
                      width={50}
                      height={50}
                    />
