        ...
        <div className="container relative mx-auto px-4 py-12 flex flex-col md:flex-row gap-8 font-Montserrat">
          ...
          <div className="flex-1">
            ...
            <div className="flex mt-4 gap-4">
              ...
              />
              <Image
                src="/images/carouselCaptions.png"
                alt="Thumbnail 2"
                className="rounded-md cursor-pointer hover:ring-2 hover:ring-blue-500"
                width={100}
                height={100}
          ...
          <div className="flex-1">
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <Image src="/images/icn favorite.png" alt="heart" width={24} height={24} />
              <Image src="/images/icn favorite (1).png" alt="cart" width={24} height={24} />
              <Image src="/images/icn favorite (2).png" alt="eye" width={24} height={24} />
            </div>
            </div>
          </div>
        </div>
              ...
              <div>
                ...
                <ul className="mt-2 space-y-4 text-[#737373] font-Montserrat font-bold text-[14px] leading-[20px]">
                  <li className="flex items-center gap-2">
                    <Image src="/images/Vector (13).png" alt="Arrow" width={12} height={12} />
